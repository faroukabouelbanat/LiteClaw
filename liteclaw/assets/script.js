// LiteClaw - JavaScript pour l'interface de chat
...
async function sendMessage() {
    ...
    try {
        ...
        if (data.success) {
            ...
            if (data.model_selected === 'auto') {
                modelDisplay += ' <span class="auto-model-badge">Auto-sélectionné</span>';
            }
            addMessageToUI('assistant', data.content, modelDisplay);
